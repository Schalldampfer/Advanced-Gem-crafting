...
//roads : removable by roadDismantle.sqf
...
publicTransportation = _RoadsAsphalt1 + _RoadsAsphalt2 + _RoadsAsphalt3 + _RoadsGravel + _RoadsIntersect + _RoadsMud + _RoadsPaved + _RoadsRunways + _Helipads;
