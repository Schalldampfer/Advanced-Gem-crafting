...
_TheDead = ["Hanged","Hanged_MD","Body","GraveCross1","GraveCross2","GraveCrossHelmet","Mass_grave_DZ"];
_Wells = ["Land_Misc_Well_C_EP1","Land_Misc_Well_L_EP1","MAP_Misc_Well","MAP_Misc_WellPump","MAP_pumpa","Land_pumpa"];
...
_Towers = ["MAP_vez","MAP_komin","MAP_antenna_small_roof","MAP_antenna_small_roof1","MAP_antenna_big_roof","MAP_Antenna","MAP_Vysilac_FM","MAP_telek1"];
...
_Mounted_Weapons =["M2StaticMG","KORD_high","DSHKM_RU","SPG9_CDF","Stinger_Pod","Igla_AA_pod_TK_EP1","M252","D30_CDF","SearchLight_US_EP1"];
...
publicTransportation = (_Transportation - _RoadsStructures) + _Helipads;
